      ...
      <div className="footer-top">
        <div className="footer-content text-white d-grid container">
          <div className="footer-item">
            ...
            >
              modus <span>games</span>
            </a>
            <p className="para-text">
              Games are the keys to unlocking imagination, where reality meets
              adventure, and you're the hero of your own story. Playing games
              isn't just about winning; it's about enjoying the journey, the
              challenges, and the friends you make along the way
            </p>
          </div>
