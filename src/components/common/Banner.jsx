    ...
    >
      <div className="banner-content w-100 container text-white">
        ...
        <p className="lead-text">
          Live gaming with lots of other games. Live games offer an immersive
          and dynamic gaming experience by allowing players to interact with
          real-time events and other participants from around the world. Whether
          you're battling in a massive online multiplayer environment,
          participating in live trivia quizzes, or watching and betting on live
          esports competitions, these games provide a sense of excitement and
